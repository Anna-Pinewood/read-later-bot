...
• /all - увидеть список всех материалов
• /bytags - отфильтровать материалы по тегу
...
no_tags_msg = "🏷️ У вас пока нет созданных тегов. Добавьте материалы с тегами, чтобы использовать фильтрацию."
...
# Tag filtering
select_tag_msg = "🏷️ Выберите тег для фильтрации материалов:"
filtering_by_tag_msg = "🔍 Материалы с тегом: '{tag_name}'"
no_materials_with_tag_msg = "❌ У вас нет материалов с тегом '{tag_name}'."
filter_cancelled_msg = "❌ Фильтрация отменена."
