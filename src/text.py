...
no_unread_materials_msg = "📭 У вас нет непрочитанных материалов. Попробуйте использовать /last для получения последнего добавленного материала."
mark_as_read_msg = "✅ Прочитано"
mark_as_unread_msg = "⏩ Later"
